...
enum UALBERTA_CONTROL_MODE
{
	...
	UALBERTA_CONTROL_MODE_ENUM_END=2, /*  | */
};
#endif
...
enum UALBERTA_ACTION
{
	...
	UALBERTA_SET_ATTITUDE_SOURCE=4, /*  | */
	UALBERTA_RESET_FILTER=5, /*  | */
	UALBERTA_INIT_ATTITUDE=6, /*  | */
	UALBERTA_SHUTDOWN=7, /*  | */
	UALBERTA_ACTION_ENUM_END=8, /*  | */
};
#endif
